...
class AnalysisModuleVariablesModel(object):
    ...
    _VARIABLE_NAMES = {
            "IES_STEPLENGTH": {"type": float, "min": 0.1, "max": 1.00, "step":0.1, "labelname":"Gauss Newton Steplength", "pos":0},
            "IES_INVERSION": {"type": int, "min": 0, "max": 3, "step":1, "labelname":"Inversion algorithm", "pos":1},
            "IES_DEBUG": {"type": bool, "labelname":"Print extensive log for IES analysis steps", "pos":2},
            "IES_LOGFILE": {"type": str, "labelname":"IES Log File", "pos":3},
